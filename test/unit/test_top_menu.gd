...
func test_set_page_highlights_the_current_page():
	...
	assert_eq(tm.get_node('Pages/BlockChapitres').get('theme_override_styles/panel').bg_color, Color('9ea8b4'))
	assert_eq(tm.get_node('Pages/BlockMain').get('theme_override_styles/panel').bg_color, Color('e9eaec'))
	tm.free()
