...
func update_player_stats() -> void:
	_player_pv.text = '%s' % PlayerStats.get_pv()
	_player_hab.text = '%s' % PlayerStats.get_stat('hab')
	_player_arm.text = '%s' % PlayerStats.get_stat('arm')
	_player_deg.text = '%s' % PlayerStats.get_stat('deg')
